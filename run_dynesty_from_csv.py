...
ndim = 12
# Works good:
#sampler = DynamicNestedSampler(log_likelihood, prior_transform, ndim=ndim, bound='single')

# Test:
#sampler = DynamicNestedSampler(log_likelihood, prior_transform, ndim=ndim, bound='multi')
...
fig, axes = dyplot.cornerprop(res, it=5000,
