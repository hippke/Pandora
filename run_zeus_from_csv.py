...
print(start)
start = np.full([nwalkers, prior_transform(np.random.normal(0, 1, 12))])
print(start)

# Initialise the Ensemble Sampler
sampler = zeus.EnsembleSampler(nwalkers, ndim, log_likelihood)
# Run MCMC
...
# Versuch6 : Zeus MCMC (ensemble slice)
