...
- The class-based version is more "pythonic" and in line with what users know from packages like `batman <https://github.com/lkreidberg/batman>`_, [Wotan](https://github.com/hippke/wotan), [TLS](https://github.com/hippke/TLS), and others. It offers various gimicks such as video animations of transits.
