...
# Here the fun begins. Choose these parameters:
# Planet parameters
r_planet = 63712  # radius [km] My prior: 1..100,000 km
a_planet = 149988401  # semimajor axis [km] My prior: 5e7..2e8 km
b_planet = 0.3937  # impact parameter [0..1.x] central transit is 0. My prior: 0..1
per_planet = 365.249941  # period [days] My prior: 360..370 days
M_planet = 4.15900798433339E+027  # mass [kg] My prior: 5e24..5e27
t0_planet_offset = 0.10013  # true offset from assumed t0; constant for all periods [days]. My prior: -0.5..+0.5

# Set moon parameters
r_moon = 17650  # radius [km] My prior: 1..50,000 km
a_moon = 2005300  # semimajor axis [km] My prior: 10,000...3,000,000 km
Omega_moon = 179.958  # degrees [0..90] My prior: 0..90 deg
i_moon = 87.58  # degrees [0..90]. 90 is edge-on. My prior: 0..90 deg
tau_moon = 0.84116  # moon orbital position [0..0.5] My prior: 0..0.5
M_moon = 3.76973143999587E+025  # mass [kg] My prior: 5e24..5e27
...
#plt.show()
plt.savefig('fig_retrieval.pdf', bbox_inches='tight')